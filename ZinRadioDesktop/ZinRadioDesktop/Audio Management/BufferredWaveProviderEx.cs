...
namespace ZinRadioDesktop
{
    ...
    /// </summary>
    public class BufferedWaveProviderEx : IWaveProvider
    {
        private CircularBufferEx? circularBuffer;
        ...
        public BufferedWaveProviderEx(WaveFormat waveFormat)
        {
        ...
        public void AddSamples(byte[] buffer, int offset, int count)
        {
            ...
            {
                circularBuffer = new CircularBufferEx(BufferLength);
            }
        ...
        {
            return circularBuffer?.Peek(peekOffset, buffer, offset, count) ?? 0;
        }
